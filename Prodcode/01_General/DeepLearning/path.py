...
twok_label_path_list = [
    r'Datensätze/Vorbereitete Daten/bgl_v1/2k/label_list_bgl_unique.csv',
    r"Datensätze/Vorbereitete Daten/hdfs_v1/2k/label_list_hdfs.csv",
    r"Datensätze/Vorbereitete Daten/hpc_v1/2k/label_list_hpc.csv",
    r"Datensätze/Vorbereitete Daten/proxifier_v1/2k/label_list_proxifier.csv",
    r"Datensätze/Vorbereitete Daten/zookeeper_v1/2k/label_list_zookeeper.csv"
]

twok_content_path_list = [
    r'Datensätze/Vorbereitete Daten/bgl_v1/2k/content_list_bgl.txt',
    r"Datensätze/Vorbereitete Daten/hdfs_v1/2k/content_list_hdfs.txt",
    r"Datensätze/Vorbereitete Daten/hpc_v1/2k/content_list_hpc.txt",
    r"Datensätze/Vorbereitete Daten/proxifier_v1/2k/content_list_proxifier.txt",
    r"Datensätze/Vorbereitete Daten/zookeeper_v1/2k/content_list_zookeeper.txt"
]

twok_log_path_list = [
    r'Datensätze/Vorbereitete Daten/bgl_v1/2k/BGL_2k.log',
    r"Datensätze/Vorbereitete Daten/hdfs_v1/2k/HDFS_2k.log",
    r"Datensätze/Vorbereitete Daten/hpc_v1/2k/HPC_2k.log",
    r"Datensätze/Vorbereitete Daten/proxifier_v1/2k/Proxifier_2k.log",
    r"Datensätze/Vorbereitete Daten/zookeeper_v1/2k/Zookeeper_2k.log"
]

twok_structured_path_list = [
    r'Datensätze/Vorbereitete Daten/bgl_v1/2k/BGL_2k.log_structured.csv',
    r"Datensätze/Vorbereitete Daten/hdfs_v1/2k/HDFS_2k.log_structured.csv",
    r"Datensätze/Vorbereitete Daten/hpc_v1/2k/HPC_2k.log_structured.csv",
    r"Datensätze/Vorbereitete Daten/proxifier_v1/2k/Proxifier_2k.log_structured.csv",
    r"Datensätze/Vorbereitete Daten/zookeeper_v1/2k/Zookeeper_2k.log_structured.csv"
]

twok_evaluate_content_list = [
    r'Datensätze/Vorbereitete Daten/bgl_v1/2k/BGL_2k_evaluate_content.txt',
    r"Datensätze/Vorbereitete Daten/hdfs_v1/2k/HDFS_2k_evaluate_content.txt",
    r"Datensätze/Vorbereitete Daten/hpc_v1/2k/HPC_2k_evaluate_content.txt",
    r"Datensätze/Vorbereitete Daten/proxifier_v1/2k/Proxifier_2k_evaluate_content.txt",
    r"Datensätze/Vorbereitete Daten/zookeeper_v1/2k/Zookeeper_2k_evaluate_content.txt"
]

twok_evaluate_label_list = [
    r'Datensätze/Vorbereitete Daten/bgl_v1/2k/BGL_2k_evaluate_label.csv',
    r"Datensätze/Vorbereitete Daten/hdfs_v1/2k/HDFS_2k_evaluate_label.csv",
    r"Datensätze/Vorbereitete Daten/hpc_v1/2k/HPC_2k_evaluate_label.csv",
    r"Datensätze/Vorbereitete Daten/proxifier_v1/2k/Proxifier_2k_evaluate_label.csv",
    r"Datensätze/Vorbereitete Daten/zookeeper_v1/2k/Zookeeper_2k_evaluate_label.csv"
]